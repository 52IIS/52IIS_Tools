...
const appName = ref(import.meta.env.VITE_APP_NAME || '工具坊')
...
const gotoSBTI = () => {
   window.open('/SBTI/index.html', '_blank')
}
const gotoAbout = () => {
  router.push('/about')
}
...
// 跳转到OTOClaw一键龙虾官网
const gotoOTOClaw = () => {
  window.open('https://www.otoclaw.com', '_blank')
}
      ...
      <div class="flex justify-center">
        <router-link class="flex flex-row h-24" to="/">
          ...
          <div class="flex flex-col mt-auto mb-auto">
            ...
            <!-- <div class="text-2xl">{{ appName }}</div> -->
            <div class="text-sm text-gray-500">{{ appSubtitle }}</div>
          </div>
        </router-link>
      </div>
      <!-- menu -->
      <!-- #f5f5fb -->
      <div class="flex justify-center pr-8 pl-8">
        <el-menu
          class="w-[200px]"
        ...
        >
          ...
          <el-menu-item index="otoclaw" @click="gotoOTOClaw">
            <template #title>
                <svg t="1702896616706" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="5262" width="20" height="20"><path fill="currentColor" d="M512 85.333333c235.648 0 426.666667 191.018667 426.666667 426.666667S747.648 938.666667 512 938.666667 85.333333 747.648 85.333333 512 276.352 85.333333 512 85.333333z m0 85.333334c-188.096 0-341.333333 153.237333-341.333333 341.333333s153.237333 341.333333 341.333333 341.333333 341.333333-153.237333 341.333333-341.333333S700.096 170.666667 512 170.666667z m-149.333333 128c16.938667 0 30.666667 13.728 30.666666 30.666666v256c0 16.938667-13.728 30.666667-30.666666 30.666667H320c-16.938667 0-30.666667-13.728-30.666667-30.666667V329.333333c0-16.938667 13.728-30.666666 30.666667-30.666666h42.666667z m298.666666 0c16.938667 0 30.666667 13.728 30.666667 30.666666v256c0 16.938667-13.728 30.666667-30.666667 30.666667H618.666667c-16.938667 0-30.666667-13.728-30.666667-30.666667V329.333333c0-16.938667 13.728-30.666666 30.666667-30.666666h42.666666z m-149.333333 64c47.146667 0 85.333333 38.186667 85.333333 85.333333s-38.186667 85.333333-85.333333 85.333333-85.333333-38.186667-85.333333-85.333333 38.186667-85.333333 85.333333-85.333333z"/></svg>
                <span class="ml-2">OTOClaw一键龙虾</span>
            </template>
          </el-menu-item>
          ...
          <el-menu-item index="sbti" @click="gotoSBTI">
            <template #title>
                <svg t="1702896616706" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="5262" width="20" height="20">
                  <path fill="currentColor" d="M512 64C264.6 64 64 264.6 64 512s200.6 448 448 448 448-200.6 448-448S759.4 64 512 64zm0 820c-205.4 0-372-166.6-372-372s166.6-372 372-372 372 166.6 372 372-166.6 372-372 372zm-64-262.7c0-11.9 9.6-21.6 21.6-21.6h56.8c11.9 0 21.6 9.6 21.6 21.6v56.8c0 11.9-9.6 21.6-21.6 21.6h-56.8c-11.9 0-21.6-9.6-21.6-21.6v-56.8zm0-189.2c0-11.9 9.6-21.6 21.6-21.6h56.8c11.9 0 21.6 9.6 21.6 21.6v105.6c0 11.9-9.6 21.6-21.6 21.6h-56.8c-11.9 0-21.6-9.6-21.6-21.6V452.1zM512 320c-106 0-192 86-192 192s86 192 192 192 192-86 192-192-86-192-192-192z"/>
                </svg>
                <span class="ml-2">SBTI人格测试</span>
            </template>
          </el-menu-item>
