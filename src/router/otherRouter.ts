...
export const otherRoute = [
  ...
  { 
    ...
    meta: {
      title: "MD5在线加密/解密",
      keywords: 'md5加密，md5在线加密，md5解密，md5在线解密',
      description: '在线md5加密/解密工具，一键生成md5加密字符串，支持32位和16位md5密文生成与解密',
    }
  },
  {
    path: '/json',
  ...
  {
    path: '/unqrcode',
    component: () => import('@/components/Tools/Qrcode/UnQrcode.vue'),
    name: 'unqrcode',
    meta: {
      title: "二维码识别",
      keywords: '二维码识别,二维码扫描,二维码解码',
      description: '在线识别二维码，支持扫描本地图片或上传图片',
    }
  },
  {
    path: '/decision',
  ...
  {
    path: '/subnet',
    component: () => import('@/components/Tools/Subnet/Subnet.vue'),
    name: 'Subnet',
    meta: {
      title: "子网掩码",
      keywords: '子网掩码计算、子网掩码转换',
      description: '子网掩码工具,提供子网掩码转换、子网掩码计算',
    }
  },
  {
    path: '/textedit',
  ...
  },
  {
    ...
    meta: {
      title: "M3U8视频播放器",
      keywords: 'M3U8视频播放器,播放M3U8视频',
      description: 'M3U8视频播放器，支持播放M3U8格式的视频',
    }
  },
  {
    path: '/pdf2img',
  ...
  },
  {
    ...
    meta: {
      title: "favicon在线制作",
      keywords: 'favicon在线制作,将图片转换为favicon',
      description: '将图片转换为favicon，支持批量转换',
    }
  },
  {
    path: '/asciiFont',
    component: () => import('@/components/Tools/ASCII/ASCIIFont.vue'),
    name: 'ASCIIFont',
    meta: {
      title: "ASCII艺术字生成器",
